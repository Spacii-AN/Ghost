import { SlashCommandBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, ChannelType, GuildMemberRoleManager } from 'discord.js';
...
export default {
    ...
    async execute(interaction) {
        ...
        const interval = setInterval(async () => {
            ...
            if (!guild)
                return;
            const textChannels = guild.channels.cache.filter(ch => ch.type === ChannelType.GuildText && ch.viewable && ch.permissionsFor(guild.members.me).has('SendMessages'));
